        ...
        <div className="max-w-3xl space-y-6">
          ...
          <section className="bg-white rounded-xl border border-line p-5 sm:p-6">
            ...
            <p className="text-xs text-ink-muted mb-4">
              The background of the first screen visitors see, behind the frosted panel the
              headline sits in. The still is shown first and stays as the fallback on phones, on
