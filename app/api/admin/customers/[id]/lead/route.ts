...
/**
 * PATCH /api/admin/customers/[id]/lead
 *
 * Update the lead fields for a customer: status (hot / warm / cold / …), how
 * they're being contacted, working notes, and follow-up dates.
 *
