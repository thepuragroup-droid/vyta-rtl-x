...
import { LogIn, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Beaker } from 'lucide-react';
        ...
        >
          ...
          <div className="bg-ink px-6 sm:px-8 pt-7 pb-6">
            ...
            <div className="text-center mb-5">
              <Link href="/login" className="inline-flex flex-col items-center gap-2">
                ...
                <span className="text-lg font-bold text-white tracking-tight">Aminocan</span>
              </Link>
            </div>
          </div>
          ...
          <div className="px-6 sm:px-8 py-6">
            ...
            <div className="mt-4 text-center">
              <Link href="/forgot-password" className="text-[10px] sm:text-xs text-ink-muted hover:text-bronze transition-colors">
            ...
            <div className="mt-4 text-center">
              <p className="text-ink-muted text-xs sm:text-sm">
                ...
                <Link href="/signup" className="text-bronze hover:text-bronze-dark font-medium">
                  Create one
                </Link>
              </p>
            </div>
